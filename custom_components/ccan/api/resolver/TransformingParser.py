...
class TransformingParser(Transformer):
    ...
    transport_adapter_types :    ("TRANSPORT_ADAPTER" "{" transport_adapter_description_list "}")    
    ...
    transport_adapter_description: (PROTOCOL_NAME DRIVER_NAME "(" param_def_list ")"  "->"  "(" connection_pin_list ")" ("with"|"WITH") degradation_codes_description) 
    ...
    equivalent_list:             ( "{" equivalent ("," equivalent)* "}")
